    ...
    <section class="p-4 py-3 w-100" id="formularioTernero">
        <div class="card light-text bg-card p-5">
            ...
            <div>
                ...
                <asp:Button runat="server" Text="+ Agregar Ternero" CssClass="btn btn-primary btn-lg" OnClick="agregarVaca" />
    ...
    <section class="p-4 py-3 w-100" id="formularioLote">
        <div class="card light-text bg-card p-5">
            ...
            <div>
                ...
                <asp:Button runat="server" Text="+ Crear Lote" CssClass="btn btn-primary btn-lg" OnClick="clickCrearLote" />
            </div>
        </div>
    </section>
